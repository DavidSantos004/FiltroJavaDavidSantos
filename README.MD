# Proyecto Filtro Java

## UML
![Captura de Pantalla](./sql/uml.png)
...
- listar ninjas juntos sus habilidades 
- mostrar misiones en especifico
- mostrar misiones completadas
- asiganr una mision a un ninja 
- marcar mision completada guardando en txt